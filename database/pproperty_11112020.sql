...
(26, 'Bhaskar', 'Das', 'bhaskar@gmail.com', '', 'Male', '26-11-2020', '13636965', '12412414321', '124321', 'fee39535ff4e1455f32452522ed5cb0584b36c9a', 'iQWwEZf1S', NULL, NULL, 0, '', 0, '', '', '4814779376', NULL, 'Software Engineer', '1234234532', 1, '2020-11-09 08:15:08', '2020-11-11 10:46:01', '1'),
(22, 'Arup', 'Mondal', 'arupmondal@gmail.com', 'frontend/1/in.png', 'Female', '25-11-2020', '123456789', '1231231234', '9999', '95bc10071eecd5f1715be57cd6f65651ce501f07', 'nEpbXfxUb', NULL, NULL, 0, '', 0, '', '', '4814715545', NULL, 'Software Developer', '123', 1, '2020-11-05 04:58:52', '2020-11-09 05:32:42', '0'),
(25, 'Admin', 'Admin', 'admin@admin.com', 'frontend//1624793.jpg', 'Male', '27-11-2020', '09073090507', '09073090507', '235325', '1df66c0f316e54a98138fb334511a38087d0b8eb', 'DNCyV5q7b', NULL, NULL, 0, '::1', 0, '', '', '4814715448', NULL, 'Software Engineer', '3252353', 1, '2020-11-05 05:48:06', '2020-11-11 06:27:31', '0');
...
(26, 22, 'Arup', 'Mondal', 'Indonesia', '', 'Indonesia', '2432', 100, 1508, '2020-11-05 05:36:08', '2020-11-09 02:29:41', '0'),
(28, 26, 'Bhaskar', 'Das', '34 El-Hassan street, Ad Doqi Giza Governorate', '', 'Egypt', '4444', 222, 3513, '2020-11-09 08:15:08', '2020-11-09 08:24:14', '1'),
(27, 25, 'Admin', 'Admin', 'asfsa', '', 'asfsa', '1421421', 6, 132, '2020-11-05 05:48:06', '2020-11-09 09:31:50', '0');

-- --------------------------------------------------------

--
-- Table structure for table `agents_ip`
--
...
--
-- Dumping data for table `agents_ip`
--

INSERT INTO `agents_ip` (`id`, `agent_id`, `ip`, `created_at`, `updated_at`, `is_deleted`) VALUES
(1, 25, '::1', '2020-11-09 06:47:36', '2020-11-09 01:17:36', '0');

-- --------------------------------------------------------

--
-- Table structure for table `agents_login`
--
...
(1, 'Scubajack', 'Adminn', '25d55ad283aa400af464c76d713c07ad', 'admin@admin.com', 0, 'Active', '2020-06-11 00:00:00', '2020-11-06 12:05:21');
...
INSERT INTO `groups` (`id`, `name`, `created_at`, `updated_at`, `is_deleted`) VALUES
(1, 'Admin', '2020-11-06 09:43:44', NULL, '0'),
(2, 'Agent/User', '2020-11-06 09:43:44', NULL, '0');
...
INSERT INTO `groups_agents` (`id`, `agent_id`, `group_id`, `created_at`, `updated_at`, `is_deleted`) VALUES
(1, 25, 1, '2020-11-09 12:51:40', NULL, '0'),
(2, 22, 2, '2020-11-09 12:51:40', NULL, '0'),
(3, 26, 2, '2020-11-09 12:51:40', '2020-11-09 08:24:14', '0');
...
CREATE TABLE `projects` (
  ...
  `fit` varchar(100) NOT NULL COMMENT 'RM/Sq.Ft (flt)',
  `fit1` varchar(100) NOT NULL COMMENT 'Sq.Ft From (flt1)',
  `fit2` varchar(100) NOT NULL COMMENT 'Sq.Ft To (flt2)',
  `remarks` varchar(255) DEFAULT NULL,
  `status` tinyint(1) NOT NULL,
  `slider` tinyint(1) NOT NULL COMMENT 'Show Slider (Home)',
  `sequence` int(11) NOT NULL,
  `date` varchar(10) DEFAULT NULL COMMENT 'Sale Ends (date)',
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NULL DEFAULT NULL,
  `is_deleted` char(1) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `projects` (`id`, `parent_id`, `uuid`, `name`, `slug`, `price`, `fit`, `fit1`, `fit2`, `remarks`, `status`, `slider`, `sequence`, `date`, `created_at`, `updated_at`, `is_deleted`) VALUES
(6, 0, '4815045106', 'Exclusive Listing: Heritage Boutique Hotel with 12 Bedrooms in Penang George Town World Heritage Site	', '', 3000.00, '800', '1234', '4444', 'Remarks', 1, 1, 1, '13-11-2020', '2020-11-10 09:00:31', '2020-11-11 05:44:40', '0'),
(7, 0, '4815264386', 'Quay West Residence @ Penang World City', '', 680000.00, '625', '760', '2013', '', 0, 1, 1, '', '2020-11-11 05:18:48', '2020-11-11 06:25:52', '0');

-- --------------------------------------------------------

--
-- Table structure for table `projects_descriptions`
--

CREATE TABLE `projects_descriptions` (
  `id` int(11) UNSIGNED NOT NULL,
  `project_id` int(11) UNSIGNED NOT NULL,
  `small_description` longtext NOT NULL COMMENT 'Home Page Description',
  `long_description` longtext NOT NULL COMMENT 'Project Page Description',
  `snapshot` longtext NOT NULL COMMENT 'snapshot Description',
  `features` longtext NOT NULL COMMENT 'features description',
...
--
-- Dumping data for table `projects_descriptions`
--

INSERT INTO `projects_descriptions` (`id`, `project_id`, `small_description`, `long_description`, `snapshot`, `features`, `meta_title`, `meta_keywords`, `meta_description`, `created_at`, `updated_at`, `is_deleted`) VALUES
(6, 6, 'Short Desc (desc) (Home Page)', 'LongDesc (desc1) (Project Page)', '<p><span style=\"font-weight: 700;\">Snapshot (desc2)</span><br></p>', '<p><span style=\"font-weight: 700;\">Features (desc3)</span><br></p>', 'Meta Title', 'Meta Keyword', 'Meta Desc', '2020-11-10 09:00:31', '2020-11-11 05:44:40', '0'),
(7, 7, 'Fronting the spectacular shoreline along the Queens Bay area where the sparkling azure seas and the sandy beaches are your neighbour, life at QuayWest is a luxury microcosm of endless choices.', 'Live it up in glamorous style, just like the rich and famous do. Where every priviledge that they have come to expect in life is presented to them on a silver platter. This is exactly the kind of unexpected pleasure you will get to enjoy when you make QuayWest your home.\r\nFronting the spectacular shoreline along the Queens Bay area where the sparkling azure seas and the sandy beaches are your neighbour, life at QuayWest is a luxury microcosm of endless choices. Here, QuayWest you will be living in the centre of calm, while ripples of an exciting world revolves around you.', '<table data-mce-style=\"height: 366px; width: 330px;\" class=\"mceItemTable\" style=\"cursor: default; border: 1px dashed rgb(187, 187, 187); font-family: Verdana, Arial, Helvetica, sans-serif; height: 366px; width: 330px;\"><tbody><tr><td style=\"color: rgb(0, 0, 0); font-size: 10px; margin: 8px; cursor: text; border: 1px dashed rgb(187, 187, 187);\">Price </td><td style=\"color: rgb(0, 0, 0); font-size: 10px; margin: 8px; cursor: text; border: 1px dashed rgb(187, 187, 187);\">: Tower A averagely MYR 680/sqft (>600); Tower B averagely MYR 570/sqft (>550)</td></tr><tr><td style=\"color: rgb(0, 0, 0); font-size: 10px; margin: 8px; cursor: text; border: 1px dashed rgb(187, 187, 187);\">Type</td><td style=\"color: rgb(0, 0, 0); font-size: 10px; margin: 8px; cursor: text; border: 1px dashed rgb(187, 187, 187);\">: Condominium Residences (Commercial Title)</td></tr><tr><td style=\"color: rgb(0, 0, 0); font-size: 10px; margin: 8px; cursor: text; border: 1px dashed rgb(187, 187, 187);\">Total Units</td><td style=\"color: rgb(0, 0, 0); font-size: 10px; margin: 8px; cursor: text; border: 1px dashed rgb(187, 187, 187);\">: 1,235 nos. (Tower A-669, Tower B-566)</td></tr><tr><td style=\"color: rgb(0, 0, 0); font-size: 10px; margin: 8px; cursor: text; border: 1px dashed rgb(187, 187, 187);\">Total Floors</td><td style=\"color: rgb(0, 0, 0); font-size: 10px; margin: 8px; cursor: text; border: 1px dashed rgb(187, 187, 187);\">: <span id=\"docs-internal-guid-68c55061-7fff-a953-b7cf-cba36cd83c63\">25</span></td></tr><tr><td style=\"color: rgb(0, 0, 0); font-size: 10px; margin: 8px; cursor: text; border: 1px dashed rgb(187, 187, 187);\">Built-up</td><td style=\"color: rgb(0, 0, 0); font-size: 10px; margin: 8px; cursor: text; border: 1px dashed rgb(187, 187, 187);\"><span data-mce-style=\"text-decoration: underline;\" style=\"text-decoration-line: underline;\"><span id=\"docs-internal-guid-ac56b800-7fff-252a-feb3-29b2cf410443\">TOWER A:</span></span><br>Type B1: 1,470 sq ft<br><span id=\"docs-internal-guid-6392bb89-7fff-6f39-0870-a5228832e8c1\">Type B2: 1,866 sq ft</span><br><span id=\"docs-internal-guid-810caea6-7fff-837f-3493-0cd46ff92264\">Type C1: 1,866 sq ft</span><br><span id=\"docs-internal-guid-f6b83df9-7fff-9b09-9b8a-dfce10d6e273\">Type D1&D3: 1,310 sq ft</span><br><span id=\"docs-internal-guid-cee61bdb-7fff-ae26-7a82-8444e81191f4\">Type D2:1,386 sq ft</span><br>Type D4: 1,434 sq ft <br>Type E1: 1,986 sq ft <br>Type E2&E3: 2,013 sq ft <br>Type F1/F2: 1,246 sq ft<br><br><span data-mce-style=\"text-decoration: underline;\" style=\"text-decoration-line: underline;\">TOWER B:</span> <br><div>Type A1/A1a: 760 sq ft <br><div>Type C2: 1,819 sq ft <br><div>Type C3: 1,723 sq ft <br><div>Type F3: 1,219 sq ft <br><div>Type G: 1,419 sq ft</div></div></div></div></div></td></tr><tr><td style=\"color: rgb(0, 0, 0); font-size: 10px; margin: 8px; cursor: text; border: 1px dashed rgb(187, 187, 187);\"><span id=\"docs-internal-guid-7f3270e5-7fff-5a77-30fe-70a56e54da04\">Ceiling Height</span></td><td style=\"color: rgb(0, 0, 0); font-size: 10px; margin: 8px; cursor: text; border: 1px dashed rgb(187, 187, 187);\">: <span id=\"docs-internal-guid-143fe155-7fff-b027-99c1-b9d7105fe281\">11 ft floor to floor, 10.6 ft clear</span></td></tr><tr><td style=\"color: rgb(0, 0, 0); font-size: 10px; margin: 8px; cursor: text; border: 1px dashed rgb(187, 187, 187);\">Maintenance </td><td style=\"color: rgb(0, 0, 0); font-size: 10px; margin: 8px; cursor: text; border: 1px dashed rgb(187, 187, 187);\">: RM0.25/sqft + 10% sinking fund</td></tr></tbody></table><table data-mce-style=\"height: 123px; width: 329px;\" class=\"mceItemTable\" style=\"cursor: default; border: 1px dashed rgb(187, 187, 187); font-family: Verdana, Arial, Helvetica, sans-serif; height: 123px; width: 329px;\"><tbody><tr><td style=\"color: rgb(0, 0, 0); font-size: 10px; margin: 8px; cursor: text; border: 1px dashed rgb(187, 187, 187);\">Car Park</td><td style=\"color: rgb(0, 0, 0); font-size: 10px; margin: 8px; cursor: text; border: 1px dashed rgb(187, 187, 187);\">: 2 lots per unit (3 for duplex)</td></tr><tr><td style=\"color: rgb(0, 0, 0); font-size: 10px; margin: 8px; cursor: text; border: 1px dashed rgb(187, 187, 187);\">Tenure</td><td style=\"color: rgb(0, 0, 0); font-size: 10px; margin: 8px; cursor: text; border: 1px dashed rgb(187, 187, 187);\">: Freehold</td></tr><tr><td style=\"color: rgb(0, 0, 0); font-size: 10px; margin: 8px; cursor: text; border: 1px dashed rgb(187, 187, 187);\">Completion</td><td style=\"color: rgb(0, 0, 0); font-size: 10px; margin: 8px; cursor: text; border: 1px dashed rgb(187, 187, 187);\">: Mid 2020</td></tr><tr><td style=\"color: rgb(0, 0, 0); font-size: 10px; margin: 8px; cursor: text; border: 1px dashed rgb(187, 187, 187);\"> </td><td style=\"color: rgb(0, 0, 0); font-size: 10px; margin: 8px; cursor: text; border: 1px dashed rgb(187, 187, 187);\"> <br><br></td></tr></tbody></table><table style=\"height: 123px; width: 329px;\"><tbody><tr><td></td><td></td></tr><tr><td></td><td></td></tr><tr><td></td><td></td></tr><tr><td></td><td></td></tr></tbody></table>', '<ul style=\"color: rgb(0, 0, 0); font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 10px;\"><li>Excellent location – in the middle of 1st & 2nd bridge & mature residential and commercial districts</li><li>Magnificent Sea & Pulau Jerejak view</li><li>2 Private lifts with direct access into individual unit entrance foyer</li><li>4 acres of facilities & garden on podium</li><li>Rooftop Garden cum lap pool concept</li><li>Water Feature at Guard entrance</li><li>24-hour Security Guard House</li><li>Color screen intercom system to Guard House</li><li>Multi-link accessibility to all Penang Island</li><li>Rental yield of 4% - 6% per annum</li><li>Availability of hotels & food court within the vicinity</li><li>Nearby Sg Nibong main express bus terminal</li><li>Availability of Taxi transportation</li><li>Nearby Pantai Hospital</li><li>Extraordinary pricing – high end design with maid range price</li><li>Facilities include Lounge, Children’s Pool, Jacuzzi Seating, Sky Pool with Infinity Pool, Pool Deck Space, Children’s Play Area, Private Garden, Private Cabana, Gymnasium, Community Hall / Reading Room, Corridor Walkway, Sky Viewing Deck on Top of Water Tank.</li><li>Features Private Garden / Terrace, Unique Layout – Bungalows in the air, Open concept kitchen and dining area <br>High Quality bathroom floor & wall tiles, Perfect manicured landscaping design, Parameter featured fencing, Unique archiform external building façade</li><li>Surrounding Amenities: 500 meter to Queensbay Mall- the largest mall in Penang island, 5km to Penang International Airport, 4km to FTZ, 2km to Penang Bridge, 5km to 2nd Penang Bridge, 8km to Ferry Terminal, 13km to famous Tourist Belt of Batu Ferringhi, 8km to downtown Georgetown, 9km to famous Gurney Drive / Hawker Centre.</li><li>Security system in place: Card Entry System with CCTV, 2 cards for car entry, 3 cards for lift access. <br><div><div> </div> </div></li></ul>', 'Quay West Residence @ Penang World City', '', '', '2020-11-11 05:18:49', '2020-11-11 06:25:52', '0');
...
INSERT INTO `projects_images` (`id`, `project_id`, `image`, `sort_order`, `thumbnail`, `created_at`, `updated_at`, `is_deleted`) VALUES
(42, 6, 'frontend/1/br.png', 1, 0, '2020-11-11 05:44:41', '2020-11-11 05:44:41', '0'),
(43, 6, 'frontend/1/in.png', 2, 0, '2020-11-11 05:44:41', '2020-11-11 05:44:41', '0'),
(44, 6, 'frontend/1/in.png', 3, 1, '2020-11-11 05:44:41', '2020-11-11 05:44:41', '0'),
(45, 6, 'frontend/1/br.png', 4, 0, '2020-11-11 05:44:41', '2020-11-11 05:44:41', '0'),
(46, 7, 'frontend/1/br.png', 1, 1, '2020-11-11 06:25:52', '2020-11-11 06:25:52', '0');

-- --------------------------------------------------------

--
-- Table structure for table `projects_subs`
--

CREATE TABLE `projects_subs` (
  `id` int(11) UNSIGNED NOT NULL,
  `project_id` int(11) UNSIGNED NOT NULL,
  `status` tinyint(1) NOT NULL,
  `name` text NOT NULL,
...
--
-- Dumping data for table `projects_subs`
--

INSERT INTO `projects_subs` (`id`, `project_id`, `status`, `name`, `sequence`, `remarks`, `description`, `created_at`, `updated_at`, `is_deleted`) VALUES
(2, 6, 1, 'FAÇADE', '2', 'Remraks', '<h6><span style=\"color: rgb(0, 0, 0); font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 10px;\">A new class and breed of Heritage Boutique Hotel in Georgetown. Its fundamental attributes are innovative, sophisticated, and authentic style.</span></h6>', '2020-11-11 03:36:28', '2020-11-11 06:27:29', '0');

-- --------------------------------------------------------

--
-- Table structure for table `projects_subs_images`
--

CREATE TABLE `projects_subs_images` (
  `id` int(11) UNSIGNED NOT NULL,
  `project_sub_id` int(11) UNSIGNED NOT NULL,
  `project_id` int(11) UNSIGNED NOT NULL,
  `image` varchar(255) DEFAULT NULL,
  `sort_order` int(11) NOT NULL,
  `thumbnail` tinyint(1) NOT NULL DEFAULT 0,
...
--
-- Dumping data for table `projects_subs_images`
--

INSERT INTO `projects_subs_images` (`id`, `project_sub_id`, `project_id`, `image`, `sort_order`, `thumbnail`, `created_at`, `updated_at`, `is_deleted`) VALUES
(66, 2, 6, 'frontend/1/br.png', 1, 0, '2020-11-11 05:44:57', '2020-11-11 05:44:57', '0'),
(67, 2, 6, 'frontend/1/in.png', 2, 1, '2020-11-11 05:44:57', '2020-11-11 05:44:57', '0');
...
--
-- Indexes for table `agents_ip`
--
ALTER TABLE `agents_ip`
  ADD PRIMARY KEY (`id`),
  ADD KEY `ip` (`ip`),
  ADD KEY `users_id` (`agent_id`);

--
-- Indexes for table `agents_login`
--
ALTER TABLE `agents_login`
  ADD PRIMARY KEY (`id`),
  ADD KEY `email` (`email`),
  ADD KEY `ip` (`ip`);
...
--
-- Indexes for table `projects_descriptions`
--
ALTER TABLE `projects_descriptions`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `projects_subs`
--
ALTER TABLE `projects_subs`
  ADD PRIMARY KEY (`id`),
  ADD KEY `project_id` (`project_id`);

--
-- Indexes for table `projects_subs_images`
--
ALTER TABLE `projects_subs_images`
  ADD PRIMARY KEY (`id`),
  ADD KEY `project_sub_id` (`project_sub_id`,`project_id`);
...
--
-- AUTO_INCREMENT for table `agents_ip`
--
ALTER TABLE `agents_ip`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `agents_login`
--
ALTER TABLE `agents_login`
...
--
-- AUTO_INCREMENT for table `groups_agents`
--
ALTER TABLE `groups_agents`
...
--
-- AUTO_INCREMENT for table `projects_descriptions`
--
ALTER TABLE `projects_descriptions`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
-- AUTO_INCREMENT for table `projects_subs`
--
ALTER TABLE `projects_subs`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `projects_subs_images`
--
ALTER TABLE `projects_subs_images`
