...
<script>
    ...
    myLabel.fetch           = '<?php echo url('item/onLoadDatatableEventHandler');?>';
    myLabel.status          = '<?php echo url('item/onChangeStatusEventHandler');?>';
    myLabel.delete          = '<?php echo url('item/delete');?>';
</script>