...
<script>
    ...
    myLabel.fetch           = '<?php echo url('inspection/onLoadDatatableEventHandler');?>';
    myLabel.status          = '<?php echo url('inspection/onChangeStatusEventHandler');?>';
    myLabel.delete          = '<?php echo url('inspection/delete');?>';
</script>