...
<script>
    ...
    myLabel.fetch           = '<?php echo url('page/onLoadDatatableEventHandler');?>';
    myLabel.status          = '<?php echo url('page/onChangeStatusEventHandler');?>';
    myLabel.delete          = '<?php echo url('page/delete');?>';
</script>