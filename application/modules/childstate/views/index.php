...
<script>
    ...
    myLabel.fetch           = '<?php echo url('childstate/onLoadDatatableEventHandler/');?>';
    myLabel.status          = '<?php echo url('childstate/onChangeStatusEventHandler');?>';
    myLabel.delete          = '<?php echo url('childstate/delete');?>';
</script>