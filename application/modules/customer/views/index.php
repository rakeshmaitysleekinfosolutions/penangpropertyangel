<div class="content container-fluid">
    <div class="row">
        ...
        <div class="col-sm-8 text-right m-b-30">
            <button type="button" class="btn btn-primary" id="deleteBtn"><i class="fa fa-trash"></i> Delete</button>
...
<script>
    ...
    myLabel.fetch           = '<?php echo url('customer/onLoadDatatableEventHandler');?>';
    myLabel.status          = '<?php echo url('customer/onChangeStatusEventHandler');?>';
    myLabel.delete          = '<?php echo url('customer/delete');?>';
    myLabel.states          = '<?php echo url('customer/states');?>';
</script>