...
<script>
    ...
    myLabel.users   = '<?php echo admin_url('customers/onLoadDatatableEventHandler');?>';
    myLabel.updateStatus   = '<?php echo admin_url('customers/onChangeStatusEventHandler');?>';
    myLabel.delete   = '<?php echo admin_url('customers/delete');?>';
    myLabel.states  = '<?php echo admin_url('customers/states');?>';
    myLabel.edit    = '<?php echo admin_url('customers/edit/');?>';
</script>