...
<script>
    ...
    myLabel.fetch           = '<?php echo url('category/onLoadDatatableEventHandler/');?>';
    myLabel.status          = '<?php echo url('category/onChangeStatusEventHandler');?>';
    myLabel.delete          = '<?php echo url('category/delete');?>';
</script>