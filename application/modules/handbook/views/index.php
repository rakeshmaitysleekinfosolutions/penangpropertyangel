...
<script>
    ...
    myLabel.fetch           = '<?php echo url('handbook/onLoadDatatableEventHandler');?>';
    myLabel.status          = '<?php echo url('handbook/onChangeStatusEventHandler');?>';
    myLabel.delete          = '<?php echo url('handbook/delete');?>';
</script>