...
class Paypal {
    ...
    public function __construct() {
        ...
        */
        ...
        $this->apiContext = new ApiContext(
            new \PayPal\Auth\OAuthTokenCredential(
                'AQjobjQpeGhnbnRtl9DOrK8V2syZIqYrvbFhDBvRLQiQsoYsdMBminnmOsMW_Aid4bMz79ZCC2-jjO2C',
                'EBYbtPg3UfbGazX_QSDeuAbeginWTm5wSfiEM1kMXTxQkfYPcmfSiqcaOp0meDnzOyCARslqFJ-ZlSWl'
            )
        );
